/**
 * Administra las clase para el contro de impresion
 * 
 * @version 1.0.0
 * 
 */
export namespace PrinterServer {
	//#region  Defines
	...
	/** Clase para administrar los formularios de Impresion */
   ...
   */
	export const Commands = {
		...
		PAPER: {
			...
			PAPER_PART_CUT_A: '\x1d\x56\x41', // Partial cut paper
			PAPER_PART_CUT_B: '\x1d\x56\x42' // Partial cut paper
		},
		TEXT_FORMAT: {
